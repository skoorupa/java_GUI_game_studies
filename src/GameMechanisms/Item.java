...
public enum Item {
    ...
    Defence_Shield1("Drewniana tarcza",ItemType.ARMOR,15, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.DEFEND,5)},ItemUsage.PASSIVE, "assets/items/armor/shield-1.png"),
    Defence_Shield2("Srebrna tarcza",ItemType.ARMOR,30, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.DEFEND,10)},ItemUsage.PASSIVE, "assets/items/armor/shield-2.png"),
    Defence_Shield3("Ognista tarcza",ItemType.ARMOR,45, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.DEFEND,15)},ItemUsage.PASSIVE, "assets/items/armor/shield-3.png"),
    Defence_Shield4("Złota tarcza",ItemType.ARMOR,60, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.DEFEND,30)},ItemUsage.PASSIVE, "assets/items/armor/shield-4.png"),
    Defence_Shield5("Diamentowa tarcza",ItemType.ARMOR,90, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.DEFEND,60)},ItemUsage.PASSIVE, "assets/items/armor/shield-5.png"),
    ...
    Clover1("Koniczyna",ItemType.SPECIAL,20, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.CRITCHANCE,20)},ItemUsage.PASSIVE,"assets/items/special/clover.png"),
    FastBoots1("Szybkie buty",ItemType.SPECIAL,20, new Effect[]{new Effect(TargetCharacter.HERO,TargetField.ESCAPECHANCE,20)},ItemUsage.PASSIVE,"assets/items/special/sonic-shoes.png")
    ;
